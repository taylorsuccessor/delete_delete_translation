...
namespace App\module\project\admin\controller;
...
use App\module\project\admin\request\createRequest;
use App\module\project\admin\request\editRequest;
use Session;
...
use App\module\project\admin\repository\ProjectContract as rProject;
...
class Project extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        $oResults=$this->rProject->getByFilter($request,$statistic);
            ...
            return view('admin.project::index', compact('oResults','request','statistic'));
    ...
    */
    public function create(Request $request,rUser $rUser)
    {
        ...
        return view('admin.project::create',compact('request','userList'));
    }
    ...
    */
    public function edit($id,rUser $rUser)
    {
        ...
        $project=$this->rProject->show($id);
            ...
            $userList=$rUser->getAllList();
            return view('admin.project::edit', compact('project','userList'));
    }
