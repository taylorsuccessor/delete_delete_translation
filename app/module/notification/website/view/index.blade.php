...
@section('content')
    ...
    $canShow=canAccess('website.notification.show');
    $canEdit=canAccess('website.notification.edit');
    $canDestroy=canAccess('website.notification.destroy');
    $canCreate=canAccess('website.notification.create');
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('website.notification.create')}}"class="btn btn-primary form-control">
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('notification::notification.to_field'), 'to_field', $oResults) !!}
                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="7">
                                        {!! th_sort(trans('notification::notification.to_email'), 'to_email', $oResults) !!}
                                    </th>
                                        ...
                                        {!! th_sort(trans('notification::notification.data'), 'data', $oResults) !!}
                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="10">
                                        {!! th_sort(trans('notification::notification.body'), 'body', $oResults) !!}
                                    </th>
                                        ...
                                        {!! th_sort(trans('notification::notification.updated_at'), 'updated_at', $oResults) !!}
                                    </th>
                                        ...
                                        <td>
                                            ...
                                            <div class="tableActionsMenuDiv">
                                                <div class="innerContainer">
                                                    ...
                                                    'url' => ['/website/notification::notification',$oResult->id]]) !!}
...
@endif
                                                        @if($canEdit )
                                            <a href="/website/notification/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
@endif
                                                            @if($canShow)
                                                    <a href="/website/notification/{{ $oResult->id }}"
...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('name', null, ['placeholder'=>trans('notification::notification.name'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('type', null, ['placeholder'=>trans('notification::notification.type'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('status', null, ['placeholder'=>trans('notification::notification.status'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('to_field', null, ['placeholder'=>trans('notification::notification.to_field'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('to_email', null, ['placeholder'=>trans('notification::notification.to_email'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('language', null, ['placeholder'=>trans('notification::notification.language'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('data', null, ['placeholder'=>trans('notification::notification.data'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('created_at', null, ['placeholder'=>trans('notification::notification.created_at'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('updated_at', null, ['placeholder'=>trans('notification::notification.updated_at'),'class'=>'form-control input-sm ']) !!}
