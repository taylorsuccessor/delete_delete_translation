                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-9 col-sm-3">
                                            ...
                                            <button type="submit" name="create" class="btn btn-primary form-control" v-on:click="submit">Edit</button>
                                        </div>
                                    </div>
...
<script>
    ...
    mounted(){
        console.log('mounted');
        axios.get('http://localhost:8000/admin/vue/'+this.$route.params.id,this.data).then((response)=>{
    ...
    methods:{
        submit(){
            axios.patch('http://localhost:8000/admin/vue/'+this.$route.params.id,this.data).then((response)=>{
