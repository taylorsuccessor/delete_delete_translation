...
class UserServiceProvider extends ServiceProvider
{
    ...
    public function bootView(){
        ...
        $this->loadViewsFrom(__DIR__.'/admin/view', 'admin.user');
...
$this->loadMigrationsFrom(base_path('app/module/user/database/migration'));
}

public function registerFactory()
{
$this->app->make('Illuminate\Database\Eloquent\Factory')->load(base_path('app/module/user/database/factory'));
...
public function registerRepository(){
    ...
    $this->app->bind(
    'App\module\user\admin\repository\UserContract',
    'App\module\user\admin\repository\EloquentUserRepository'
    );
