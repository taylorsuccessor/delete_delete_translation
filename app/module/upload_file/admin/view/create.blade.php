            ...
            <div class="row bg-title" style="background:url(/assets/admin/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('upload_file::upload_file.upload_fileCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('upload_file::upload_file.addupload_file') }}</p>
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                {!! Form::model($request,['url' => '/admin/upload_file', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('upload_file::upload_file.addupload_file') }}</span>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group {{ $errors->has('upload_group_id') ? 'has-error' : ''}}  col-xs-6">
                                                {!! Form::label('user_id', trans('upload_file::upload_file.upload_group_id'), ['class' => 'col-sm-4 control-label']) !!}
                                                <div class="col-sm-8">
