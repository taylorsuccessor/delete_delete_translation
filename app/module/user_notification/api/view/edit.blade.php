            ...
            <div class="row bg-title" style="background:url(/assets/admin/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('user_notification::user_notification.edituser_notification') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('user_notification::user_notification.edituser_notification') }}</p>
                        <!-- Nav tabs -->
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('user_notification::user_notification.edituser_notification') }}</span>
                                    </div>
