...
<?php     $canShow=canAccess('api.user_notification.show');
    $canEdit=canAccess('api.user_notification.edit');
    $canDestroy=canAccess('api.user_notification.destroy');
    $canCreate=canAccess('api.user_notification.create');
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('api.user_notification.create')}}"class="btn btn-primary form-control">
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('user_notification::user_notification.body'), 'body', $oResults) !!}
                                    </th>
                                        ...
                                        {!! th_sort(trans('user_notification::user_notification.updated_at'), 'updated_at', $oResults) !!}
                                    </th>
                                        ...
                                        <td>
                                            ...
                                            <div class="tableActionsMenuDiv">
                                                <div class="innerContainer">
                                                    ...
                                                    'url' => ['/api/user_notification',$oResult->id]]) !!}
...
@endif
                                                        @if($canEdit )
                                            <a href="/api/user_notification/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
@endif
                                                            @if($canShow)
                                                    <a href="/api/user_notification/{{ $oResult->id }}"
